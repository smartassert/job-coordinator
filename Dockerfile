...
ENV START_WORKER_JOB_DELAY_MS=$START_WORKER_JOB_DELAY_MS
...
ENV GET_WORKER_STATE_CHANGE_CHECK_PERIOD_MS=$GET_WORKER_STATE_CHANGE_CHECK_PERIOD_MS
ENV IS_READY=$READY
ENV VERSION=$VERSION
