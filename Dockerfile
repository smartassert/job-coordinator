...
ARG RESULTS_JOB_CHANGE_CHECK_PERIOD_MS=30000
...
ARG RESULTS_NOTIFY_SECRET=results_notify_secret
...
ENV RESULTS_JOB_CHANGE_CHECK_PERIOD_MS=$RESULTS_JOB_CHANGE_CHECK_PERIOD_MS
...
ENV RESULTS_NOTIFY_SECRET=$RESULTS_NOTIFY_SECRET
