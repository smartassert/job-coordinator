...
class ResultsJobRetriever extends AbstractRetriever implements JobComponentPreparationStateRetrieverInterface
{
    ...
    {
        return $this->doGet($jobId, RemoteRequestType::createForResultsJobCreation());
    }
}
