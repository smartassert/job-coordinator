...
class RemoteRequestRemoverForEvents implements EventSubscriberInterface
{
    ...
    {
        $this->remoteRequestRemover->removeForJobAndType($event->getJobId(), RemoteRequestType::RESULTS_CREATE);
    }

    public function removeSerializedSuiteCreateRequests(SerializedSuiteCreatedEvent $event): void
    {
        $this->remoteRequestRemover->removeForJobAndType(
            $event->getJobId(),
    ...
    {
        $this->remoteRequestRemover->removeForJobAndType($event->getJobId(), RemoteRequestType::SERIALIZED_SUITE_GET);
    }
    ...
    {
        $this->remoteRequestRemover->removeForJobAndType($event->getJobId(), RemoteRequestType::RESULTS_STATE_GET);
    }
