...
use App\MessageFailureHandler\SerializedSuiteRetrievalExceptionHandler;
...
class SerializedSuiteRetrievalExceptionHandlerTest extends WebTestCase
{
    use RemoteRequestFailureCreationDataProviderTrait;
    use MockeryPHPUnitIntegration;

    private SerializedSuiteRetrievalExceptionHandler $handler;
    private Job $job;
    ...
    protected function setUp(): void
    {
        ...
        $handler = self::getContainer()->get(SerializedSuiteRetrievalExceptionHandler::class);
        \assert($handler instanceof SerializedSuiteRetrievalExceptionHandler);
    ...
    public function testHandleSetRemoteRequestFailure(
        ...
        $this->handler->handle(new SerializedSuiteRetrievalException($this->job, $throwable));
